    ...
    <div class="hidden md:w-2/4 text-center justify-self-center flex flex-col justify-center">
        <div class="">
            <div class="text-lg leading-7 font-semibold">
                <a href="" class=" mt-4 text-2xl sm:text-3xl md:text-4xl text-gray-900 dark:text-white">{{__('Why choosing us')}}</a>
            </div>
        </div>
    </div>
        ...
        <div class="card p-2 mb-3 w-full lg:w-1/3 flex flex-col space-y-8">
            <div class="card-header flex flex-col text-center items-center justify-center">
                ...
                <h4 class=" mt-2 text-lg font-medium text-gray-900 dark:text-white">{{__('Increase Productivity')}}</h4>
                <p class="mt-2 text-gray-600 dark:text-gray-400 text-base">
                    {{__('Get the best places to increase your productivity.')}}</p>
            </div>
        </div>
        <div class="card p-2 mb-3 w-full lg:w-1/3 flex flex-col space-y-8">
            <div class="card-header flex flex-col text-center items-center justify-center">
                ...
                <h4 class=" mt-2 text-lg font-medium text-gray-900 dark:text-white">{{__('Reach Professionalism')}}</h4>
                <p class="mt-2 text-gray-600 dark:text-gray-400 text-base">
                  {{__('Achieve your goals with professionalism and creativity.')}}</p>
            </div>
        </div>
    </div>
</div>
