	...
	<div class="relative py-3 sm:max-w-xl sm:mx-auto">
		...
		<div class="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
			<div class="max-w-md mx-auto">
				<div>
					<h1 class="text-2xl text-indigo-700 font-semibold">Edit Person</h1>
				</div>
                    ...
                    <form action="{{ route('users.update',$user->id)}}" method="POST">
                      ...
                      <div class="grid grid-cols-6 gap-6">
                        <div class=" relative col-span-6 sm:col-span-3">
                                <input  id="first-name" name="f_name" type="text" value="{{ $user->f_name }}" value="{{ old('f_name')}}" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" />
                        ...
                        <div class="relative col-span-6 sm:col-span-3">
                             <input  id="last-name" name="l_name" type="text" value="{{ $user->l_name }}" value="{{ old('l_name')}}" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600"  />
                        ...
                        <div class="relative col-span-6 sm:col-span-3">
                                <input  id="phone" name="phone" type="text" value="{{ $user->phone }}" value="{{ old('phone')}}" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" />
                        ...
                        <div class="relative col-span-6 sm:col-span-4">
                                <input  id="email-address" name="email" type="text"  value="{{ $user->email }}" value="{{ old('email')}}" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600"  />
                        ...
                        <div class="col-span-6 sm:col-span-6">
                            ...
                            <select id="Status" name="status" value="{{ $user->status }}" class="mt-1 block w-full h-10 rounded py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 ">
