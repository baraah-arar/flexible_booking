                        ...
                        <div class="card bg-gray-100 shadow-md rounded-lg px-4 py-4 mb-6 ">
                            <form action="{{ route('places.update',$place->id)}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="flex items-center justify-center">
                                  ...
                                  <input id="price" name="price" type="number" min="0" step="any" value="{{ $place->price }}" value="{{ old('price')}}" class="rounded px-4 w-full py-1 bg-gray-200  border border-gray-400 mb-3 text-gray-700 placeholder-gray-700 focus:bg-white focus:outline-none"/>
                                       @error('price')
                                         <p class="text-red-500 text-xs mt-1">{{$message}}</p>
                                       @enderror
