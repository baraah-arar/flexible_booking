          ...
          <div class="flex justify-center items-start my-2">
            <div class="w-full sm:w-10/12 md:w-1/2 my-1">
                ...
                <div class="text-center">
                  <p>
                    By<a href="{{ route('users.show',$item->user_id)}}" class="text-indigo-600 text-sm hover:underline hover:text-indigo-800 ml-2">{{ $item->author->f_name}} {{ $item->author->l_name }} </a>
                  </p>
                <a href="{{ route('dashboard.opinions_index')}}" class="inline-flex justify-center py-1 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"> Back </a>
               </div>
            </div>
          </div>
