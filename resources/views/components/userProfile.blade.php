...
<div class="container bootdey">
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-4">
            ...
            <div class="portlet light profSile-sidebar-portlet bordered">
                ...
                <div class="profile-usermenu">
                    <ul class="nav">
                        <li class="active">
                            <a onclick="showRes()" href="#">
                                <i class="icon-home"></i> My Reservations </a>
                        </li>
                        <li>
                            <a onclick="showEdit()" href="#">
...
<!-- footer -->
<div
    class="footer flex flex-col md:flex-row justify-center mt-4 items-center sm:justify-between sm:px-6 lg:px-8">
    <div class="text-center text-sm text-gray-500 sm:text-left">
        <div class="flex items-center">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                 aria-hidden="true" role="img" width="1.03em" height="1em" preserveAspectRatio="xMidYMid meet"
                 viewBox="0 0 256 250">
                <path
