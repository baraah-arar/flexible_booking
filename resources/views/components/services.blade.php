...
<div class="self-start w-full flex flex-col">
    <h1 class="text-xl text-gray-900 dark:text-white">please select start and end date for your reservation</h1>
    <div class="indivd_form mt-8 self-center flex flex-col items-center justify-center">
        <form action="" method="put" class="flex flex-col md:flex-row items-center justify-center">
            ...
            <div class="flex items-center justify-center mx-2">
                ...
                <input type="text" value="" name="start_date" id="checkIn" class="input-date-focus appearance-none rounded-none relative block h-10 w-full px-3 py-2 border-b border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md bg-transparent focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm">
...
<div class="hor-card services-card my-8 grid grid-cols-1 md:grid-cols-3" data-num-plc="01">
    <div class="w-full h-full row-start-1 col-start-1 col-end-3">
        <div style="background-image:url('/images/indv.svg')" class="bg-cover bg-no-repeat bg-center h-full w-full"></div>
        ...
        <div class="body-sec row-start-1 col-start-2 col-end-4 my-8 flex flex-col bg-gray-200 shadow p-8 opacity-80">
            ...
            <a class="book_indvidual cursor-pointer mt-8 self-end py-2 text-base px-6 text-white font-medium bg-indigo-600 hover:bg-indigo-700">Book now</a>
        </div>
    </div>
</div>
@else
                ...
                <div class="flex items-center flex-col">
                    <input type="hidden" value="{{$place->id}}" name="plc_id">
                        <div class="w-full flex flex-col justify-center items-center">
                            ...
                            <div class="w-full flex items-center justify-center mx-2">
                                <label for="hoursNum" class="sr-only">{{$place->plc_type == 'meeting'? 'Hours' : 'Days'}}</label>
                                <label for="hoursNum" class="p-4 w-1/5">{{$place->plc_type == 'meeting'? 'Hours' : 'Days'}}</label>
